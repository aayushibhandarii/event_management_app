...
class Socialevent extends StatefulWidget {
  const Socialevent({super.key});

  @override
  State<Socialevent> createState() => _SocialeventState();
}

class _SocialeventState extends State<Socialevent> {
                    ...
                    if(ids != null){
                      ids.forEach((ids,value){
                        ...
                        if(value != null){
                          ...
                          if(event["Event type"].toString().toLowerCase() == "social event"){
                            list.add(event);
                          }
                        }
